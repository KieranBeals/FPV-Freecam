...
public final class DroneSetupScreen extends Screen {
    ...
    protected void init() {
        ...
        this.deadzoneBox = this.layout.addChild(new EditBox(this.font, 90, 20, Component.translatable("screen.fpvfreecam.deadzone")));
        ...
        footer.addChild(Button.builder(Component.translatable("screen.fpvfreecam.done"), button -> this.onClose()).width(90).build());
